...
One of the properties of RC11 that is ensured by the incremental algorithm is coherence. This is interesting because coherence isn't exclusive to RC11 but is in fact used by other memory models. Once the incremental algorithm had been implemented in herd, I was tasked with writing an incremental algorithm that would ensure coherence. This algorithm would then take check the coherent executions against a cat model.
